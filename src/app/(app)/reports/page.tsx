...
import { buildMonthlyReportData } from "@/lib/reports/aggregate-report";
...
export default async function ReportsPage({ searchParams }: ReportsPageProps) {
  ...
  const { sessions, filterOptions } = await getMonthlyReportSessions(monthView);
  const filteredSessions = applyReportFilters(sessions, filters);
  const report = buildMonthlyReportData(filteredSessions);
